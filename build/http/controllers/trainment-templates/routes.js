...
__export(routes_exports, {
  trainmentTemplateRoutes: () => trainmentTemplateRoutes
});
...
async function createTrainmentTemplate(request, reply) {
  const createTrainmentTemplateBodySchema = import_zod2.z.object({
...
async function deleteTrainmentTemplate(request, reply) {
  const deleteTrainmentTemplateParamsSchema = import_zod3.z.object({
...
async function getTrainmentTemplate(request, reply) {
  const getTrainmentTemplateParamsSchema = import_zod4.z.object({
...
async function updateTrainmentTemplate(request, reply) {
  const updateTrainmentTemplateParamsSchema = import_zod5.z.object({
    id: import_zod5.z.uuid()
  });
  const updateTrainmentTemplateBodySchema = import_zod5.z.object({
...
// src/http/controllers/trainment-templates/routes.ts
async function trainmentTemplateRoutes(app) {
