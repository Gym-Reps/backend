...
__export(routes_exports, {
  exerciseTemplateRoutes: () => exerciseTemplateRoutes
});
...
async function addExerciseToTemplate(request, reply) {
  ...
  const bodySchema = import_zod2.z.object({ exerciseCatalogId: import_zod2.z.uuid() });
...
// src/http/controllers/exercise-templates/routes.ts
async function exerciseTemplateRoutes(app) {
