...
var UpdateUserPreferencesUseCase = class {
  constructor(userPreferencesRepository2) {
...
// src/use-cases/user-preferences/update-user-preferences/update-user-preferences.spec.ts
...
describe("Update User Preferences Use Case", () => {
  ...
  it("merges a single key without altering the others", async () => {
    ...
    globalExpect(value.weightUnit).toEqual("lb");
    globalExpect(value.theme).toEqual("light");
    globalExpect(value.lengthUnit).toEqual("meters");
    globalExpect(value.weeklyTrainingCount).toBeNull();
  });
  it("replaces multiple keys at once", async () => {
    ...
    const value = resolvePreferences(userPreferences.preferences);
    globalExpect(value.lengthUnit).toEqual("inches");
    globalExpect(value.weeklyTrainingCount).toEqual(5);
  });
