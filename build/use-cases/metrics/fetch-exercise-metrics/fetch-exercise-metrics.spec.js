...
var FetchExerciseMetricsUseCase = class {
  constructor(metricsRepository2, exercisesRepository2, trainmentsRepository2) {
...
// src/use-cases/metrics/fetch-exercise-metrics/fetch-exercise-metrics.spec.ts
var metricsRepository;
var exercisesRepository;
var trainmentsRepository;
var sut;
async function seedExercise(userId) {
...
describe("Fetch Exercise Metrics Use Case", () => {
  ...
  it("returns the owned exercise's metrics", async () => {
    ...
    globalExpect(metrics[0]?.weight_diff).toBe(-2.5);
  });
