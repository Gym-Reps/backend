...
// src/use-cases/trainment-templates/update-trainment-template/update-trainment-template.spec.ts
...
describe("Update Trainment Template Use Case", () => {
  ...
  it("should be able to rename a template for the owner", async () => {
    ...
    globalExpect(trainmentTemplate.title).toEqual("Upper A (revised)");
    globalExpect(trainmentTemplatesRepository.items[0]?.title).toEqual(
      "Upper A (revised)"
    );
  });
