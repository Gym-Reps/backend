...
// src/use-cases/trainment-templates/delete-trainment-template/delete-trainment-template.spec.ts
...
describe("Delete Trainment Template Use Case", () => {
  ...
  it("should soft-delete a template so reads exclude it", async () => {
    ...
    globalExpect(trainmentTemplatesRepository.items[0]?.deleted_at).toEqual(
