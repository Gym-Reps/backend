...
var FetchTrainmentExercisesUseCase = class {
  constructor(exercisesRepository2, trainmentsRepository2) {
...
// src/use-cases/exercises/fetch-trainment-exercises/fetch-trainment-exercises.spec.ts
...
describe("Fetch Trainment Exercises Use Case", () => {
  ...
  it("lists the performed exercises of an owned session", async () => {
    ...
    globalExpect(exercises).toHaveLength(2);
  });
