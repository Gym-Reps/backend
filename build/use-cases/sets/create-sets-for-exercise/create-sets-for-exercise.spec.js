...
// src/use-cases/sets/create-sets-for-exercise/create-sets-for-exercise.spec.ts
var setsRepository;
var sut;
var plannedSets = {
...
describe("Create Sets For Exercise Use Case", () => {
  ...
  it("materializes one unlogged set per planned index", async () => {
    ...
    globalExpect(sets.every((s) => s.weight === null && s.repetitions === null)).toBe(
      true
    );
    globalExpect(sets.every((s) => s.user_id === "user-1")).toBe(true);
    globalExpect(
