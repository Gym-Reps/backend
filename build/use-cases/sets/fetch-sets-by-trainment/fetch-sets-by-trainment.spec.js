...
var FetchSetsByTrainmentUseCase = class {
  constructor(setsRepository2, trainmentsRepository2) {
...
// src/use-cases/sets/fetch-sets-by-trainment/fetch-sets-by-trainment.spec.ts
var setsRepository;
...
describe("Fetch Sets By Trainment Use Case", () => {
  ...
  it("returns all sets for the owned session", async () => {
    ...
    globalExpect(sets).toHaveLength(2);
  });
