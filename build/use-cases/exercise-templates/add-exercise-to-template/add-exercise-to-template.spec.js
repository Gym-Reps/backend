...
var AddExerciseToTemplateUseCase = class {
  constructor(exerciseTemplatesRepository2, trainmentTemplatesRepository2, defaultExercisesRepository2) {
    ...
    this.defaultExercisesRepository = defaultExercisesRepository2;
  }
...
// src/use-cases/exercise-templates/add-exercise-to-template/add-exercise-to-template.spec.ts
var exerciseTemplatesRepository;
var trainmentTemplatesRepository;
var defaultExercisesRepository;
var sut;
...
describe("Add Exercise To Template Use Case", () => {
  ...
  it("adds a catalog exercise, snapshotting its title, and bumps the parent updated_at", async () => {
    ...
    globalExpect(exerciseTemplate.title).toEqual("Barbell Squat");
    globalExpect(exerciseTemplate.exercise_catalog_id).toEqual(catalog.id);
    globalExpect(exerciseTemplate.trainment_template_id).toEqual(template.id);
