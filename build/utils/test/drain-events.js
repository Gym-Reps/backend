...
// src/utils/test/drain-events.ts
var drain_events_exports = {};
__export(drain_events_exports, {
  drainEvents: () => drainEvents
});
module.exports = __toCommonJS(drain_events_exports);
...
async function drainEvents() {
  ...
  const pending = await eventsRepository.findStalePending(/* @__PURE__ */ new Date());
